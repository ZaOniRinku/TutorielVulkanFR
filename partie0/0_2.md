...
Il est possible de récupérer le projet de base depuis [**la branche ``debut`` sur GitHub**](https://github.com/ZaOniRinku/TutorielVulkanFR/tree/module/debut). Celui-ci contient déjà GLFW mais vous demande tout de même d'installer un environnement de développement C++, CMake et VulkanSDK.
...
[**Partie précédente**](0_1.md) - [**Index**](../index.md)
