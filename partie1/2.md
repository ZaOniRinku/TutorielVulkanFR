...
À chaque fois qu'un objet Vulkan est crée, celui-ci doit être détruit lorsque nous n'en avons plus besoin. Nous pouvons donc détruire l'instance Vulkan dans la méthode ``destroy()`` :
