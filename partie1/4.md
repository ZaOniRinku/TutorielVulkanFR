...
On a aussi la mention d'extensions de *device*, avec ``enabledExtensionCount`` et ``ppEnabledExtensionNames``. Nous n'allons pas en activer pour le moment mais nous allons en activer un peu plus tard.
