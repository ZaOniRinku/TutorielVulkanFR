...
- **Vertex shader** : Prend en entrée des *vertices* (points d'un maillage) dans le repère de leur modèle et sort des *vertices* dans le repère image.

![Repère modèle et image](images/repere_modele_image.png)
