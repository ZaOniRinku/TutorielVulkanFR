...
``dstBinding`` est le ``binding`` qui correspond à celui du *shader* et celui du layout de *Descriptor Set*. Pour les matrices de la caméra, ``binding = 0`` et pour les matrices modèles des objets, ``binding = 1``.
