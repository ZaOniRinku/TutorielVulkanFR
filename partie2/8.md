...
Pour pallier ce problème, nous allons créer une texture de 1 pixel blanc. Comme exemple de texture présente pour signifier qu'il n'y a pas de texture, le moteur de jeu [**Source**](https://developer.valvesoftware.com/wiki/Source) de Valve et Minecraft utilisent une texture en damier noir et rose.
